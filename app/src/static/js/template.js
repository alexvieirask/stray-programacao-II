$(function () {
  ...
  if (jwt) {
    ...
    function headerWithUser(data) {
      ...
      var exitButton = $("<img>") .attr("src", "../static/img/others/exit.jpg").addClass("username-img-header");
