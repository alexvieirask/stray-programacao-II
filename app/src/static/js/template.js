$(function () {
  ...
  if (JWT) {
    ...
    function headerWithUser(data) {
      ...
      var exitButton = $("<img>")
        .attr("src", "../static/img/fixed/exit.jpg")
        .addClass("username-img-header");
