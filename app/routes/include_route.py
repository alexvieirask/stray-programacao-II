...
1. User
    ...
    Linux:
    curl -d '{"name":"Alex Vieira Dias","username":"alexvieiradiasSK","email":"alexvieiradias2019@gmail.com","password":"teste"}' -X  POST -H "Content-Type:application/json" localhost:5000/user/include
    
    curl -d '{"name":"Emanoela Rodrigues Erthal","username":"manu.erthal","email":"emanoela@gmail.com","password":"teste"}' -X  POST -H "Content-Type:application/json" localhost:5000/user/include
...
2. Game
    ...
    Linux: 
    curl -d '{"title":"The Game of Year","description":"This game...","categorie":"aventura","price":"50.99","required_age":"0","launch_date":"24/01/2005","developer":"God"}' -X  POST -H "Content-Type:application/json" localhost:5000/user/include
